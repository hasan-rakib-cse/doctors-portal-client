        ...
        <nav className="navbar navbar-expand-lg navbar-light">
            <div className="container-fluid">
                <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li className="nav-item"><NavLink to={'/reviews'} className='navlink text-white me-5'>Reviews</NavLink></li>
                    <li className="nav-item"><NavLink to={'/blog'} className='navlink text-white me-5'>Blog</NavLink></li>
                    <li className="nav-item"><NavLink to={'/contact-us'} className='navlink text-white me-5'>Contact Us</NavLink></li>
                </ul>
